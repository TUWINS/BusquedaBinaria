...
public class BusquedaBinaria {
        ...
        try {
            ...
            BufferedReader br = new BufferedReader(new FileReader("entrada_binary.txt"));
            ...
            BufferedWriter bw = new BufferedWriter(new FileWriter("salida_binary.txt"));
            ...
            System.out.println("Búsqueda Binaria única completada. Resultado en salida_binary.txt");  /*  Mensaje de confirmación*/
